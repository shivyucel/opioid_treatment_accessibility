...
r5r_core <- setup_r5(data_path =  '/Users/shivyucel/Documents/projects.nosync/opioid_accessibility/project/project_dir/data/toronto_data/2019_routing/r5r_core', verbose = FALSE)
```
...
departure_time<- as.POSIXct("26-06-2019 9:00:00", format = "%d-%m-%Y %H:%M:%S")
...
max_walk_dist <- 10000
max_trip_duration <- 120
departure_time<- as.POSIXct("26-06-2019 12:00:00", format = "%d-%m-%Y %H:%M:%S")
...
```{r}
cens = st_write(ttm1200, "/Users/shivyucel/Documents/projects.nosync/opioid_accessibility/project/project_dir/data/toronto_data/2019_routing/travel_times/26_06_2019_1200.csv")
...
max_walk_dist <- 10000
max_trip_duration <- 120
departure_time<- as.POSIXct("26-06-2019 14:00:00", format = "%d-%m-%Y %H:%M:%S")
...
```{r}
cens = st_write(ttm1400, "/Users/shivyucel/Documents/projects.nosync/opioid_accessibility/project/project_dir/data/toronto_data/2019_routing/travel_times/26_06_2019_1400.csv")
