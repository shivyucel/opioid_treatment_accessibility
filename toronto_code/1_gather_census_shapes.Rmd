...
census_data <- get_census(dataset='CA16', regions=list(CMA="35535"),
                          vectors=c("v_CA16_3831","v_CA16_401","v_CA16_2213"),
...
```{r}
library(sf)
cens = st_write(census_data, "/Users/shivyucel/Documents/projects.nosync/Toronto_Health_Accessibility/data/imm_pop_inc.csv")
